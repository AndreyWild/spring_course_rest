package com.wild.spring.rest.configuration;
...
@Configuration
@ComponentScan(basePackages = "com.wild.spring.rest") // откуда брать компоненты
@EnableWebMvc
...
public class MyConfig {
    ...
    public LocalSessionFactoryBean sessionFactory(){
        ...
        sessionFactory.setPackagesToScan("com.wild.spring.rest.entity");
